...
drop function if exists priv.assert_valid_password;
...
drop function if exists publ.reset_password;
create function publ.reset_password(user_id uuid, reset_token text, new_password text) returns boolean as $$
declare
  v_user publ.users;
...
grant execute on function publ.reset_password to :DATABASE_VISITOR; 